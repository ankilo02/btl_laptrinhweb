            ...
            <div class="row">
                ...
                <div class="col-lg-4 hidden-md hidden-sm hidden-xs">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="#" class="linkss"><i class="fa fa-map-marker"></i>15-17 Tôn Đức Thắng, Q.1, TP. HCM</a></li>
                            <li><a href="#" class="linkss"><i class="fa fa-phone"></i>+84-0123456789</a></li>
                            <li><a href="#" class="linkss"><i class="fa fa-envelope-o"></i>bk@hcmut.edu.vn</a></li>
                        </ul>
                    </div>
                    <div class="footer">
